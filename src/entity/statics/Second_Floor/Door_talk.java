...
public class Door_talk extends StaticEntity {

    private int id;

    public Door_talk(Handler handler, float x, float y, int id) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.door1, (int)(x- handler.getGameCamera().getxOffset()),
