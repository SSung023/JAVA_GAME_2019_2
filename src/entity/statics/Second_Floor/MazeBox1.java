...
public class MazeBox1 extends StaticEntity {

    private int id;

    public MazeBox1(Handler handler, float x, float y,  int id) {
    ...
    @Override
    public void die() {
        handler.getWorld().getItemManager().addItem(Item.SSDItem.createNew((int)x-25, (int)y-40));
        Item.isSSD = true;
    }
